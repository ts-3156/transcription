...
user.requests.create(name: 'サンプルデータ 4月10日のインタビュー', created_at: 3.days.ago).tap do |r|
...
user.requests.create(name: 'サンプルデータ 5月10日のミーティング', created_at: 2.days.ago).tap do |r|
...
user.requests.create(name: 'サンプルデータ 6月10日のセミナー', created_at: 1.days.ago).tap do |r|
